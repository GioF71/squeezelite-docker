...
:---|:---|:---
2023-06-13|`bookworm` builds tagged as `latest`, `sid` tagged as `edge`, see [#206](https://github.com/GioF71/squeezelite-docker/issues/206)
2023-06-13|Sourceforge builds based on `bookworm`, see [#206](https://github.com/GioF71/squeezelite-docker/issues/206)
